...
clang++ -o ./build/test $OPT $DISASSEMBLY $ARCH -std=c++14 $CXXFLAGS $ASAN -Isrc src/bikeshed.cpp third-party/nadir/src/nadir.cpp test/test.cpp test/main.cpp -pthread
