...
clang++ -o ./build/test_debug -DBIKESHED_ASSERTS $OPT $DISASSEMBLY $ARCH -std=c++14 $CXXFLAGS $ASAN -Isrc src/bikeshed.cpp third-party/nadir/src/nadir.cpp test/main.cpp -pthread
